...
class SensorModelApi(object):
    ...
    def sensor_model_create(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sensor_model_create_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def sensor_model_delete(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sensor_model_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def sensor_model_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_model_delete`")  # noqa: E501
    ...
    def sensor_model_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sensor_model_get_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def sensor_model_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_model_get`")  # noqa: E501
    ...
    def sensor_model_get_all(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sensor_model_get_all_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def sensor_model_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['manufacturers', 'product_codes', 'names', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'max_items']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `sensor_model_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `sensor_model_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}

        path_params = {}

        query_params = []
        if 'manufacturers' in params:
            query_params.append(('manufacturers', params['manufacturers']))  # noqa: E501
    ...
    def sensor_model_update(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sensor_model_update_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def sensor_model_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_model_update`")  # noqa: E501
