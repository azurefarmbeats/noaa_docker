...
class PartnerApi(object):
    ...
    def partner_create(self, **kwargs):  # noqa: E501
        """Creates new partner with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param PartnerRequest input: Partner request object.
        ...
        return self.partner_create_with_http_info(**kwargs)  # noqa: E501

    def partner_create_with_http_info(self, **kwargs):  # noqa: E501
        """Creates new partner with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PartnerResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='PartnerResponse',  # noqa: E501
    ...
    def partner_delete(self, id, **kwargs):  # noqa: E501
        """Deletes the partner with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_delete(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Id of the partner object. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partner_delete_with_http_info(id, **kwargs)  # noqa: E501

    def partner_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes the partner with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `partner_delete`")  # noqa: E501
    ...
    def partner_get(self, id, **kwargs):  # noqa: E501
        """Returns partner for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_get(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partner_get_with_http_info(id, **kwargs)  # noqa: E501

    def partner_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Returns partner for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `partner_get`")  # noqa: E501
    ...
    def partner_get_all(self, **kwargs):  # noqa: E501
        """Returns list of partners.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_get_all(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[str] names: Gets or sets list of names of partner.
        :param list[str] object_ids: Gets or sets list of Object id's.
        :param list[str] partner_types: Gets or sets list of Partner Types.
        :param list[str] tenant_ids: Gets or sets list of Tenant id's.
        :param list[str] includes: Gets or sets list of properties to be included in PartnerResponse. Default value is None.
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: PartnerLimitedResponseListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.partner_get_all_with_http_info(**kwargs)  # noqa: E501

    def partner_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Returns list of partners.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PartnerLimitedResponseListResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['names', 'object_ids', 'partner_types', 'tenant_ids', 'includes', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'property_filter', 'max_items', 'x_ms_continuation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `partner_get_all`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `partner_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'partner_types' in local_var_params and local_var_params['partner_types'] is not None:  # noqa: E501
            query_params.append(('partnerTypes', local_var_params['partner_types']))  # noqa: E501
            collection_formats['partnerTypes'] = 'multi'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PartnerLimitedResponseListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def partner_renew(self, id, **kwargs):  # noqa: E501
        """Renew connection strings of event hub.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_renew(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Id of partner (system-generated). (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partner_renew_with_http_info(id, **kwargs)  # noqa: E501

    def partner_renew_with_http_info(self, id, **kwargs):  # noqa: E501
        """Renew connection strings of event hub.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_renew_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `partner_renew`")  # noqa: E501
    ...
    def partner_update(self, id, **kwargs):  # noqa: E501
        """Updates the partner with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_update(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Id of the partner. (required)
        :param PartnerRequest input: Partner request object.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partner_update_with_http_info(id, **kwargs)  # noqa: E501

    def partner_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Updates the partner with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partner_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `partner_update`")  # noqa: E501
