...
class RuleApi(object):
    ...
    def rule_create(self, **kwargs):  # noqa: E501
        """Creates new rule with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param RuleRequest input: Rule request object.
        ...
        return self.rule_create_with_http_info(**kwargs)  # noqa: E501

    def rule_create_with_http_info(self, **kwargs):  # noqa: E501
        """Creates new rule with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RuleResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='RuleResponse',  # noqa: E501
    ...
    def rule_delete(self, id, **kwargs):  # noqa: E501
        """Deletes the rule with given id.  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str id: Id of the rule object. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def rule_get(self, id, **kwargs):  # noqa: E501
        """Returns rule for the given id.  # noqa: E501
    ...
    def rule_get_all(self, **kwargs):  # noqa: E501
        """Returns list of rules.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_get_all(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[str] names: Gets or sets list of names of rules.
        :param list[str] farm_ids: Gets or sets list of farm id's.
        :param list[str] severity_levels: Gets or sets list of severity levels.
        :param str rule_status: Gets or sets rule enabled.
        :param list[str] includes: Gets or sets list of properties to be included in RuleResponse. Default value is None.
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: RuleResponseListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.rule_get_all_with_http_info(**kwargs)  # noqa: E501

    def rule_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Returns list of rules.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RuleResponseListResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['names', 'farm_ids', 'severity_levels', 'rule_status', 'includes', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'property_filter', 'max_items', 'x_ms_continuation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `rule_get_all`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `rule_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'severity_levels' in local_var_params and local_var_params['severity_levels'] is not None:  # noqa: E501
            query_params.append(('severityLevels', local_var_params['severity_levels']))  # noqa: E501
            collection_formats['severityLevels'] = 'multi'  # noqa: E501
        if 'rule_status' in local_var_params and local_var_params['rule_status'] is not None:  # noqa: E501
            query_params.append(('ruleStatus', local_var_params['rule_status']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RuleResponseListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def rule_update(self, id, **kwargs):  # noqa: E501
        """Updates the rule with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_update(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Id of the rule. (required)
        :param RuleRequest input: Rule request object.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.rule_update_with_http_info(id, **kwargs)  # noqa: E501

    def rule_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Updates the rule with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rule_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `rule_update`")  # noqa: E501
