...
class DeviceModelApi(object):
    ...
    def device_model_get_all(self, **kwargs):  # noqa: E501
        ...
        :param list[str] includes: Gets or sets list of properties to be included in DeviceModelResponse. Default value is None.
    ...
    def device_model_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['names', 'type', 'manufactures', 'product_codes', 'includes', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'property_filter', 'max_items', 'x_ms_continuation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `device_model_get_all`, must be a value less than or equal to `1000`")  # noqa: E501
