...
class DeviceModelApi(object):
    ...
    def device_model_create(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.device_model_create_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def device_model_delete(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.device_model_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def device_model_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `device_model_delete`")  # noqa: E501
    ...
    def device_model_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.device_model_get_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def device_model_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `device_model_get`")  # noqa: E501
    ...
    def device_model_get_all(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.device_model_get_all_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def device_model_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `device_model_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `device_model_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'manufactures' in params:
            query_params.append(('manufactures', params['manufactures']))  # noqa: E501
            collection_formats['manufactures'] = 'multi'  # noqa: E501
        if 'product_codes' in params:
            query_params.append(('productCodes', params['product_codes']))  # noqa: E501
    ...
    def device_model_update(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.device_model_update_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def device_model_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `device_model_update`")  # noqa: E501
