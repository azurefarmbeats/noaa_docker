...
class FarmApi(object):
    ...
    def farm_create(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.farm_create_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def farm_delete(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.farm_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def farm_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `farm_delete`")  # noqa: E501
    ...
    def farm_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.farm_get_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def farm_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `farm_get`")  # noqa: E501
    ...
    def farm_get_all(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.farm_get_all_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def farm_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `farm_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `farm_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def farm_update(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.farm_update_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def farm_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `farm_update`")  # noqa: E501
