...
class FarmApi(object):
    ...
    def farm_get_all(self, **kwargs):  # noqa: E501
        ...
        :param list[str] includes: Gets or sets list of properties to be included in FarmResponse. Default value is None.
    ...
    def farm_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `farm_get_all`, must be a value less than or equal to `1000`")  # noqa: E501
