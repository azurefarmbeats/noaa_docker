...
class DeviceApi(object):
    ...
    def device_create(self, **kwargs):  # noqa: E501
        """Creates new device with given request body.  # noqa: E501
    ...
    def device_delete(self, id, **kwargs):  # noqa: E501
        """Deletes the device with given id and parameters.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.device_delete_with_http_info(id, **kwargs)  # noqa: E501

    def device_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes the device with given id and parameters.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `device_delete`")  # noqa: E501
    ...
    def device_get(self, id, **kwargs):  # noqa: E501
        """Returns device for the given Id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_get(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.device_get_with_http_info(id, **kwargs)  # noqa: E501

    def device_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Returns device for the given Id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `device_get`")  # noqa: E501
    ...
    def device_get_all(self, **kwargs):  # noqa: E501
        """Returns list of devices.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_get_all(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[str] names: Gets or sets list of names of devices.
        :param list[str] device_model_ids: Gets or sets list of device model ids.
        :param list[str] farm_ids: Gets or sets list of farm ids.
        :param list[str] parent_device_ids: Gets or sets list of parent device ids.
        :param list[str] hardware_ids: Gets or sets list of hardware ids.
        :param list[str] includes: Gets or sets list of properties to be included in DeviceResponse. Default value is None.
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: DeviceResponseListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.device_get_all_with_http_info(**kwargs)  # noqa: E501

    def device_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Returns list of devices.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DeviceResponseListResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['names', 'device_model_ids', 'farm_ids', 'parent_device_ids', 'hardware_ids', 'includes', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'property_filter', 'max_items', 'x_ms_continuation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `device_get_all`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `device_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'device_model_ids' in local_var_params and local_var_params['device_model_ids'] is not None:  # noqa: E501
            query_params.append(('deviceModelIds', local_var_params['device_model_ids']))  # noqa: E501
            collection_formats['deviceModelIds'] = 'multi'  # noqa: E501
        ...
        if 'parent_device_ids' in local_var_params and local_var_params['parent_device_ids'] is not None:  # noqa: E501
            query_params.append(('parentDeviceIds', local_var_params['parent_device_ids']))  # noqa: E501
            collection_formats['parentDeviceIds'] = 'multi'  # noqa: E501
        if 'hardware_ids' in local_var_params and local_var_params['hardware_ids'] is not None:  # noqa: E501
            query_params.append(('hardwareIds', local_var_params['hardware_ids']))  # noqa: E501
            collection_formats['hardwareIds'] = 'multi'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DeviceResponseListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def device_update(self, id, **kwargs):  # noqa: E501
        """Updates the device with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_update(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: Id of the device. (required)
        :param DeviceRequest input: New device object.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.device_update_with_http_info(id, **kwargs)  # noqa: E501

    def device_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Updates the device with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.device_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `device_update`")  # noqa: E501
