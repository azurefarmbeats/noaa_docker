...
class JobTypeApi(object):
    ...
    def job_type_create(self, **kwargs):  # noqa: E501
        """Creates new job type with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param JobTypeRequest input: User's job type request.
        ...
        if kwargs.get('async_req'):
            return self.job_type_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.job_type_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def job_type_create_with_http_info(self, **kwargs):  # noqa: E501
        """Creates new job type with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='JobTypeResponse',  # noqa: E501
    ...
    def job_type_delete(self, id, **kwargs):  # noqa: E501
        """Deletes job type with given id and parameters.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_delete(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id of job type to deleted (system-generated). (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.job_type_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.job_type_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def job_type_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes job type with given id and parameters.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `job_type_delete`")  # noqa: E501
    ...
    def job_type_get(self, id, **kwargs):  # noqa: E501
        """Returns job type for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: job type id (system-generated). (required)
        :return: JobTypeResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.job_type_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.job_type_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def job_type_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Returns job type for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `job_type_get`")  # noqa: E501
    ...
    def job_type_get_all(self, **kwargs):  # noqa: E501
        """Returns list of job types.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_get_all(async_req=True)
        >>> result = thread.get()
        ...
        :return: JobTypeResponseListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.job_type_get_all_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.job_type_get_all_with_http_info(**kwargs)  # noqa: E501
            return data

    def job_type_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Returns list of job types.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['names', 'status', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'property_filter', 'max_items', 'x_ms_continuation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method job_type_get_all" % key
                )
            params[key] = val
        del params['kwargs']

        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `job_type_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `job_type_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='JobTypeResponseListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def job_type_update(self, id, **kwargs):  # noqa: E501
        """Updates job type with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_update(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id of job type that need to be updated (system-generated). (required)
        :param JobTypeRequest input: New state of job type.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.job_type_update_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.job_type_update_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def job_type_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Updates job type with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.job_type_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `job_type_update`")  # noqa: E501
