...
class SceneApi(object):
    ...
    def scene_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['types', 'sources', 'farm_id', 'sequence', 'min_scene_date', 'max_scene_date', 'names', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'max_items']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
