...
class RoleDefinitionApi(object):
    ...
    def role_definition_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.role_definition_get_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def role_definition_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `role_definition_get`")  # noqa: E501
    ...
    def role_definition_get_all(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.role_definition_get_all_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def role_definition_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `role_definition_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `role_definition_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
