...
class SensorApi(object):
    ...
    def sensor_create(self, **kwargs):  # noqa: E501
        """Creates new sensor with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_create(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SensorRequest input: Sensor request object.
        ...
        if kwargs.get('async_req'):
            return self.sensor_create_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sensor_create_with_http_info(**kwargs)  # noqa: E501
            return data

    def sensor_create_with_http_info(self, **kwargs):  # noqa: E501
        """Creates new sensor with given request body.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='SensorResponse',  # noqa: E501
    ...
    def sensor_delete(self, id, **kwargs):  # noqa: E501
        """Deletes the sensor with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_delete(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id of the sensor object. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sensor_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.sensor_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def sensor_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Deletes the sensor with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_delete`")  # noqa: E501
    ...
    def sensor_get(self, id, **kwargs):  # noqa: E501
        """Returns sensor for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sensor_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.sensor_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def sensor_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Returns sensor for the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_get`")  # noqa: E501
    ...
    def sensor_get_all(self, **kwargs):  # noqa: E501
        """Returns list of sensors.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_get_all(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] names: Gets or sets list of names of sensors.
        ...
        :return: SensorResponseListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sensor_get_all_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.sensor_get_all_with_http_info(**kwargs)  # noqa: E501
            return data

    def sensor_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Returns list of sensors.  # noqa: E501

        based on specified filters and date range. Requires ReadAll privileges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['names', 'hardware_ids', 'sensor_model_ids', 'device_ids', 'ids', 'partner_id', 'min_created_at', 'max_created_at', 'min_last_modified_at', 'max_last_modified_at', 'max_items']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sensor_get_all" % key
                )
            params[key] = val
        del params['kwargs']

        if 'max_items' in params and params['max_items'] > 5000:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `sensor_get_all`, must be a value less than or equal to `5000`")  # noqa: E501
        if 'max_items' in params and params['max_items'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_items` when calling `sensor_get_all`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'hardware_ids' in params:
            query_params.append(('hardwareIds', params['hardware_ids']))  # noqa: E501
            collection_formats['hardwareIds'] = 'multi'  # noqa: E501
        if 'sensor_model_ids' in params:
            query_params.append(('sensorModelIds', params['sensor_model_ids']))  # noqa: E501
            collection_formats['sensorModelIds'] = 'multi'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SensorResponseListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def sensor_update(self, id, **kwargs):  # noqa: E501
        """Updates the sensor with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_update(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id of the sensor. (required)
        :param SensorRequest input: Sensor request object.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sensor_update_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.sensor_update_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def sensor_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Updates the sensor with given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sensor_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `sensor_update`")  # noqa: E501
