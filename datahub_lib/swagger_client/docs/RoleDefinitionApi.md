# datahub_lib.swagger_client.RoleDefinitionApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**role_definition_get**](RoleDefinitionApi.md#role_definition_get) | **GET** /RoleDefinition/{id} | Returns role definition for the given id.
[**role_definition_get_all**](RoleDefinitionApi.md#role_definition_get_all) | **GET** /RoleDefinition | Returns list of role definitions.


# **role_definition_get**
> RoleDefinitionResponse role_definition_get(id)

Returns role definition for the given id.
...
with datahub_lib.swagger_client.ApiClient(configuration) as api_client:
    ...
    api_instance = datahub_lib.swagger_client.RoleDefinitionApi(api_client)
    id = 'id_example' # str | Role definition id given while creating a role assignment (system-generated).

    try:
        # Returns role definition for the given id.
        api_response = api_instance.role_definition_get(id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RoleDefinitionApi->role_definition_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Role definition id given while creating a role assignment (system-generated). | 

### Return type

[**RoleDefinitionResponse**](RoleDefinitionResponse.md)
...
# **role_definition_get_all**
> RoleDefinitionResponseListResponse role_definition_get_all(names=names, ids=ids, partner_id=partner_id, min_created_at=min_created_at, max_created_at=max_created_at, min_last_modified_at=min_last_modified_at, max_last_modified_at=max_last_modified_at, property_filter=property_filter, max_items=max_items, x_ms_continuation=x_ms_continuation)
...
with datahub_lib.swagger_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = datahub_lib.swagger_client.RoleDefinitionApi(api_client)
    names = ['names_example'] # list[str] | Gets or sets list of names of role definitions. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **names** | [**list[str]**](str.md)| Gets or sets list of names of role definitions. | [optional] 
...
[**RoleDefinitionResponseListResponse**](RoleDefinitionResponseListResponse.md)
