...
> DeviceModelResponseListResponse device_model_get_all(names=names, type=type, manufactures=manufactures, product_codes=product_codes, ids=ids, partner_id=partner_id, min_created_at=min_created_at, max_created_at=max_created_at, min_last_modified_at=min_last_modified_at, max_last_modified_at=max_last_modified_at, property_filter=property_filter, max_items=max_items, x_ms_continuation=x_ms_continuation)
