...
class DeviceModelIncludesFilter(object):
    ...
    allowable_values = [NONE, PORTS, PROPERTIES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """DeviceModelIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceModelIncludesFilter):
            return False
