...
class AzureBatchDetails(object):
    ...
    def __init__(self, batch_vmsku='standard_d3_v2', dedicated_computer_nodes=1, node_agent_skuid='batch.node.ubuntu 18.04', local_vars_configuration=None):  # noqa: E501
    ...
    def batch_vmsku(self):
        ...
        Gets or sets Azure Batch VM SKU.  Currently we only support linux VMs.  List of VM SKUs: https://docs.microsoft.com/en-us/azure/cloud-services/cloud-services-sizes-specs.  # noqa: E501
    ...
    def dedicated_computer_nodes(self):
        ...
        Gets or sets dedicated computer nodes for batch pool.  # noqa: E501
    ...
    def node_agent_skuid(self):
        ...
        Gets or sets Azure Batch Node Agent SKU ID.  Currently only \"batch.node.ubuntu 18.04\" batch node agent is supported.  # noqa: E501
