...
class GetSceneFileResponse(object):
    ...
    def __init__(self, download_sas_url=None, id=None, created_at=None, last_modified_at=None, blob_url=None, scene_id=None, type=None, content_type=None, name=None, description=None, properties=None):  # noqa: E501
        """GetSceneFileResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetSceneFileResponse, dict):
