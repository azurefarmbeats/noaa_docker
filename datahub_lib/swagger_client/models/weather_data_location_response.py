...
class WeatherDataLocationResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, weather_data_model_id=None, location=None, farm_id=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
        """WeatherDataLocationResponse - a model defined in OpenAPI"""  # noqa: E501
