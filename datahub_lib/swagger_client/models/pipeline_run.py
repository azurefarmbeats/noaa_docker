...
class PipelineRun(object):
    ...
    def __init__(self, run_id=None, pipeline_name=None, parameters=None, last_updated=None, run_start=None, run_end=None, duration_in_ms=None, status=None, message=None, local_vars_configuration=None):  # noqa: E501
