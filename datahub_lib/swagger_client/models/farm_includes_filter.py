...
class FarmIncludesFilter(object):
    ...
    allowable_values = [NONE, GEOMETRY, PROPERTIES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FarmIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FarmIncludesFilter):
            return False
