...
class TelemetryQueryFilter(object):
    ...
    def __init__(self, sensor_id=None, weather_data_location_id=None, search_span=None, filter=None, projected_properties=None, local_vars_configuration=None):  # noqa: E501
