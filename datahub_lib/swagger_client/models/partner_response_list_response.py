...
from datahub_lib.swagger_client.models.partner_response import PartnerResponse  # noqa: F401,E501


class PartnerResponseListResponse(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """PartnerResponseListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this PartnerResponseListResponse.  # noqa: E501

        Gets or sets list of objects.  # noqa: E501

        :return: The items of this PartnerResponseListResponse.  # noqa: E501
        :rtype: list[PartnerResponse]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this PartnerResponseListResponse.

        Gets or sets list of objects.  # noqa: E501

        :param items: The items of this PartnerResponseListResponse.  # noqa: E501
        :type: list[PartnerResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartnerResponseListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerResponseListResponse):
            return False
