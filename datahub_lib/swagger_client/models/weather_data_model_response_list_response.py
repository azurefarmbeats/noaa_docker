...
class WeatherDataModelResponseListResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[WeatherDataModelResponse]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """WeatherDataModelResponseListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this WeatherDataModelResponseListResponse.  # noqa: E501

        Gets or sets list of objects.  # noqa: E501

        :return: The items of this WeatherDataModelResponseListResponse.  # noqa: E501
        :rtype: list[WeatherDataModelResponse]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this WeatherDataModelResponseListResponse.

        Gets or sets list of objects.  # noqa: E501

        :param items: The items of this WeatherDataModelResponseListResponse.  # noqa: E501
        :type: list[WeatherDataModelResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WeatherDataModelResponseListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WeatherDataModelResponseListResponse):
            return False
