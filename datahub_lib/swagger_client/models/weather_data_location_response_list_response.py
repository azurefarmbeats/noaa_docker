...
class WeatherDataLocationResponseListResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[WeatherDataLocationResponse]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """WeatherDataLocationResponseListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this WeatherDataLocationResponseListResponse.  # noqa: E501

        Gets or sets list of objects.  # noqa: E501

        :return: The items of this WeatherDataLocationResponseListResponse.  # noqa: E501
        :rtype: list[WeatherDataLocationResponse]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this WeatherDataLocationResponseListResponse.

        Gets or sets list of objects.  # noqa: E501

        :param items: The items of this WeatherDataLocationResponseListResponse.  # noqa: E501
        :type: list[WeatherDataLocationResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WeatherDataLocationResponseListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WeatherDataLocationResponseListResponse):
            return False
