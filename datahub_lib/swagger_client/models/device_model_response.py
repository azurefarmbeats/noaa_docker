...
class DeviceModelResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, type=None, manufacturer=None, product_code=None, ports=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this DeviceModelResponse.  # noqa: E501

        Gets or sets unique id auto generated for the device type.  # noqa: E501

        :return: The id of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeviceModelResponse.

        Gets or sets unique id auto generated for the device type.  # noqa: E501

        :param id: The id of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this DeviceModelResponse.  # noqa: E501

        Gets or sets device type creation date.  # noqa: E501

        :return: The created_at of this DeviceModelResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this DeviceModelResponse.

        Gets or sets device type creation date.  # noqa: E501

        :param created_at: The created_at of this DeviceModelResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def last_modified_at(self):
        """Gets the last_modified_at of this DeviceModelResponse.  # noqa: E501

        Gets or sets device type last updated date.  # noqa: E501

        :return: The last_modified_at of this DeviceModelResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_modified_at(self, last_modified_at):
        """Sets the last_modified_at of this DeviceModelResponse.

        Gets or sets device type last updated date.  # noqa: E501

        :param last_modified_at: The last_modified_at of this DeviceModelResponse.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def type(self):
        """Gets the type of this DeviceModelResponse.  # noqa: E501

        Gets or sets type of the device.  # noqa: E501

        :return: The type of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DeviceModelResponse.

        Gets or sets type of the device.  # noqa: E501

        :param type: The type of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
    ...
    def manufacturer(self):
        """Gets the manufacturer of this DeviceModelResponse.  # noqa: E501

        Gets or sets manufacturer name of the device.  # noqa: E501

        :return: The manufacturer of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def manufacturer(self, manufacturer):
        """Sets the manufacturer of this DeviceModelResponse.

        Gets or sets manufacturer name of the device.  # noqa: E501

        :param manufacturer: The manufacturer of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                manufacturer is not None and len(manufacturer) > 200):
            raise ValueError("Invalid value for `manufacturer`, length must be less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                manufacturer is not None and len(manufacturer) < 3):
    ...
    def product_code(self):
        """Gets the product_code of this DeviceModelResponse.  # noqa: E501

        Gets or sets Device product code Or Model name/Number.  eg: EnviroMonitor#6800.  # noqa: E501

        :return: The product_code of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def product_code(self, product_code):
        """Sets the product_code of this DeviceModelResponse.

        Gets or sets Device product code Or Model name/Number.  eg: EnviroMonitor#6800.  # noqa: E501

        :param product_code: The product_code of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                product_code is not None and len(product_code) > 200):
            raise ValueError("Invalid value for `product_code`, length must be less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                product_code is not None and len(product_code) < 3):
    ...
    @property
    def ports(self):
        """Gets the ports of this DeviceModelResponse.  # noqa: E501

        Gets or sets details of ports mapped on the device.  # noqa: E501

        :return: The ports of this DeviceModelResponse.  # noqa: E501
    ...
    def ports(self, ports):
        """Sets the ports of this DeviceModelResponse.

        Gets or sets details of ports mapped on the device.  # noqa: E501

        :param ports: The ports of this DeviceModelResponse.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DeviceModelResponse.  # noqa: E501

        Gets or sets name to identify resource.  # noqa: E501

        :return: The name of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeviceModelResponse.

        Gets or sets name to identify resource.  # noqa: E501

        :param name: The name of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this DeviceModelResponse.  # noqa: E501

        Gets or sets textual description of resource.  # noqa: E501

        :return: The description of this DeviceModelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DeviceModelResponse.

        Gets or sets textual description of resource.  # noqa: E501

        :param description: The description of this DeviceModelResponse.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def properties(self):
        """Gets the properties of this DeviceModelResponse.  # noqa: E501

        Gets or sets additional properties of the resource.  # noqa: E501

        :return: The properties of this DeviceModelResponse.  # noqa: E501
    ...
    def properties(self, properties):
        """Sets the properties of this DeviceModelResponse.

        Gets or sets additional properties of the resource.  # noqa: E501

        :param properties: The properties of this DeviceModelResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceModelResponse):
            return False
