...
class PartnerStatus(object):
    ...
    swagger_types = {
        'partner_state': 'str',
        'driver_checkpoints': 'list[PartnerDriverTimeline]',
        'errors': 'list[PartnerError]'
    }

    attribute_map = {
        'partner_state': 'partnerState',
        'driver_checkpoints': 'driverCheckpoints',
        'errors': 'errors'
    }

    def __init__(self, partner_state=None, driver_checkpoints=None, errors=None):  # noqa: E501
        """PartnerStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def partner_state(self):
        """Gets the partner_state of this PartnerStatus.  # noqa: E501


        :return: The partner_state of this PartnerStatus.  # noqa: E501
        :rtype: str
        """
        return self._partner_state

    @partner_state.setter
    def partner_state(self, partner_state):
        """Sets the partner_state of this PartnerStatus.


        :param partner_state: The partner_state of this PartnerStatus.  # noqa: E501
        :type: str
        """
        allowed_values = ["Active", "Initializing", "Updating"]  # noqa: E501
        if partner_state not in allowed_values:
            raise ValueError(
                "Invalid value for `partner_state` ({0}), must be one of {1}"  # noqa: E501
                .format(partner_state, allowed_values)
            )

        self._partner_state = partner_state

    @property
    def driver_checkpoints(self):
        """Gets the driver_checkpoints of this PartnerStatus.  # noqa: E501


        :return: The driver_checkpoints of this PartnerStatus.  # noqa: E501
        :rtype: list[PartnerDriverTimeline]
        """
        return self._driver_checkpoints

    @driver_checkpoints.setter
    def driver_checkpoints(self, driver_checkpoints):
        """Sets the driver_checkpoints of this PartnerStatus.


        :param driver_checkpoints: The driver_checkpoints of this PartnerStatus.  # noqa: E501
        :type: list[PartnerDriverTimeline]
        """

        self._driver_checkpoints = driver_checkpoints

    @property
    def errors(self):
        """Gets the errors of this PartnerStatus.  # noqa: E501


        :return: The errors of this PartnerStatus.  # noqa: E501
        :rtype: list[PartnerError]
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this PartnerStatus.


        :param errors: The errors of this PartnerStatus.  # noqa: E501
        :type: list[PartnerError]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartnerStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerStatus):
            return False
