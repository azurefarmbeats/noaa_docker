...
class Location(object):
    ...
    def __init__(self, latitude=None, longitude=None, elevation=None, local_vars_configuration=None):  # noqa: E501
    ...
    def latitude(self, latitude):
        ...
        if (self.local_vars_configuration.client_side_validation and
                latitude is not None and latitude > 9E+1):  # noqa: E501
            raise ValueError("Invalid value for `latitude`, must be a value less than or equal to `9E+1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                latitude is not None and latitude < -9E+1):  # noqa: E501
            raise ValueError("Invalid value for `latitude`, must be a value greater than or equal to `-9E+1`")  # noqa: E501
    ...
    def longitude(self, longitude):
        ...
        if (self.local_vars_configuration.client_side_validation and
                longitude is not None and longitude > 1.8E+2):  # noqa: E501
            raise ValueError("Invalid value for `longitude`, must be a value less than or equal to `1.8E+2`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                longitude is not None and longitude < -1.8E+2):  # noqa: E501
            raise ValueError("Invalid value for `longitude`, must be a value greater than or equal to `-1.8E+2`")  # noqa: E501
