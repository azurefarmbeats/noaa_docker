...
class DebugInformation(object):
    ...
    def __init__(self, pipeline_runs=None):  # noqa: E501
        """DebugInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def pipeline_runs(self):
        """Gets the pipeline_runs of this DebugInformation.  # noqa: E501

        Gets or sets information about ADF pipeline runs of job.  # noqa: E501

        :return: The pipeline_runs of this DebugInformation.  # noqa: E501
    ...
    def pipeline_runs(self, pipeline_runs):
        """Sets the pipeline_runs of this DebugInformation.

        Gets or sets information about ADF pipeline runs of job.  # noqa: E501

        :param pipeline_runs: The pipeline_runs of this DebugInformation.  # noqa: E501
        :type: list[PipelineRun]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DebugInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DebugInformation):
            return False
