...
class PartnerLimitedResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, partner_status=None, object_id=None, tenant_id=None, docker_details=None, partner_type=None, name=None, description=None, properties=None):  # noqa: E501
