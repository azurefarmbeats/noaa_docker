...
class PartnerLimitedResponseListResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[PartnerLimitedResponse]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """PartnerLimitedResponseListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this PartnerLimitedResponseListResponse.  # noqa: E501

        Gets or sets list of objects.  # noqa: E501

        :return: The items of this PartnerLimitedResponseListResponse.  # noqa: E501
        :rtype: list[PartnerLimitedResponse]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this PartnerLimitedResponseListResponse.

        Gets or sets list of objects.  # noqa: E501

        :param items: The items of this PartnerLimitedResponseListResponse.  # noqa: E501
        :type: list[PartnerLimitedResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartnerLimitedResponseListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerLimitedResponseListResponse):
            return False
