...
class RuleResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, farm_id=None, conditions=None, severity_level='Info', status='Enabled', actions=None, name=None, description=None, properties=None):  # noqa: E501
