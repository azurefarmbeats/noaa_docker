...
class WeatherMeasure(object):
    ...
    def __init__(self, name=None, data_type=None, measure_enum_definition=None, type=None, unit=None, aggregation_type='None', depth=None, description=None, local_vars_configuration=None):  # noqa: E501
        """WeatherMeasure - a model defined in OpenAPI"""  # noqa: E501
