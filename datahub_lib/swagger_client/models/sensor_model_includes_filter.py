...
class SensorModelIncludesFilter(object):
    ...
    allowable_values = [NONE, PROPERTIES, SENSORMEASURES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SensorModelIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SensorModelIncludesFilter):
            return False
