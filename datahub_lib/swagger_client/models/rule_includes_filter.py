...
class RuleIncludesFilter(object):
    ...
    allowable_values = [NONE, ACTIONS, CONDITIONS, PROPERTIES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """RuleIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuleIncludesFilter):
            return False
