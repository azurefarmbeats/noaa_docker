...
class FarmRequest(object):
    ...
    def __init__(self, geometry=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
        """FarmRequest - a model defined in OpenAPI"""  # noqa: E501
