...
class FarmRequest(object):
    ...
    def __init__(self, geometry=None, name=None, description=None, properties=None):  # noqa: E501
        """FarmRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def geometry(self):
        """Gets the geometry of this FarmRequest.  # noqa: E501
    ...
    def geometry(self, geometry):
        """Sets the geometry of this FarmRequest.
    ...
    @property
    def name(self):
        """Gets the name of this FarmRequest.  # noqa: E501

        Gets or sets name to identify resource.  # noqa: E501

        :return: The name of this FarmRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FarmRequest.

        Gets or sets name to identify resource.  # noqa: E501

        :param name: The name of this FarmRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this FarmRequest.  # noqa: E501

        Gets or sets textual description of resource.  # noqa: E501

        :return: The description of this FarmRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FarmRequest.

        Gets or sets textual description of resource.  # noqa: E501

        :param description: The description of this FarmRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def properties(self):
        """Gets the properties of this FarmRequest.  # noqa: E501

        Gets or sets additional properties of the resource.  # noqa: E501

        :return: The properties of this FarmRequest.  # noqa: E501
    ...
    def properties(self, properties):
        """Sets the properties of this FarmRequest.

        Gets or sets additional properties of the resource.  # noqa: E501

        :param properties: The properties of this FarmRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FarmRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FarmRequest):
            return False
