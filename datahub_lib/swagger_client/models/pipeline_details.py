...
class PipelineDetails(object):
    ...
    def resource_group_name(self, resource_group_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                resource_group_name is not None and not re.search(r'^[-\w\._\(\)]+$', resource_group_name)):  # noqa: E501
    ...
    def data_factory_name(self, data_factory_name):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and data_factory_name is None:  # noqa: E501
