...
class JobIncludesFilter(object):
    ...
    allowable_values = [NONE, ARGUMENTS, PROPERTIES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """JobIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobIncludesFilter):
            return False
