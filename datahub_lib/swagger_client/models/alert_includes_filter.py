...
class AlertIncludesFilter(object):
    ...
    allowable_values = [NONE, RULEACTIONS]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AlertIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertIncludesFilter):
            return False
