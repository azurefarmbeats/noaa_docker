...
class DeviceRequest(object):
    ...
    def __init__(self, device_model_id=None, hardware_id=None, farm_id=None, reporting_interval=None, location=None, parent_device_id=None, name=None, description=None, properties=None):  # noqa: E501
