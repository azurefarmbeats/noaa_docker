...
class DevicePort(object):
    ...
    def __init__(self, name=None, type=None):  # noqa: E501
        """DevicePort - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DevicePort.  # noqa: E501

        Gets or sets port name on the device.  # noqa: E501

        :return: The name of this DevicePort.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DevicePort.

        Gets or sets port name on the device.  # noqa: E501

        :param name: The name of this DevicePort.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def type(self):
        """Gets the type of this DevicePort.  # noqa: E501

        Gets or sets port type of the device.  # noqa: E501

        :return: The type of this DevicePort.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DevicePort.

        Gets or sets port type of the device.  # noqa: E501

        :param type: The type of this DevicePort.  # noqa: E501
        :type: str
        """
        if type is None:
