...
class JobTypeIncludesFilter(object):
    ...
    allowable_values = [NONE, PIPELINEDETAILS, PROPERTIES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """JobTypeIncludesFilter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JobTypeIncludesFilter):
            return False
