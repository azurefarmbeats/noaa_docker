...
class SensorResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, hardware_id=None, sensor_model_id=None, location=None, depth=None, port=None, device_id=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
        """SensorResponse - a model defined in OpenAPI"""  # noqa: E501
