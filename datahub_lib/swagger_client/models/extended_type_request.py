...
class ExtendedTypeRequest(object):
    ...
    def __init__(self, key=None, value=None, description=None):  # noqa: E501
        """ExtendedTypeRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def key(self):
        """Gets the key of this ExtendedTypeRequest.  # noqa: E501

        Gets or sets key of extended type (user and system defined).  # noqa: E501

        :return: The key of this ExtendedTypeRequest.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this ExtendedTypeRequest.

        Gets or sets key of extended type (user and system defined).  # noqa: E501

        :param key: The key of this ExtendedTypeRequest.  # noqa: E501
        :type: str
        """
        if key is None:
    ...
    @property
    def value(self):
        """Gets the value of this ExtendedTypeRequest.  # noqa: E501

        Gets or sets type values associated with the key (user and system defined).  # noqa: E501

        :return: The value of this ExtendedTypeRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this ExtendedTypeRequest.

        Gets or sets type values associated with the key (user and system defined).  # noqa: E501

        :param value: The value of this ExtendedTypeRequest.  # noqa: E501
        :type: list[str]
        """
        if value is None:
    ...
    def description(self):
        """Gets the description of this ExtendedTypeRequest.  # noqa: E501

        Gets or sets textual description of resource.  # noqa: E501

        :return: The description of this ExtendedTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ExtendedTypeRequest.

        Gets or sets textual description of resource.  # noqa: E501

        :param description: The description of this ExtendedTypeRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExtendedTypeRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExtendedTypeRequest):
            return False
