...
class DockerDetails(object):
    ...
    def __init__(self, credentials=None, image_name='azurefarmbeats/farmbeats-noaa', image_tag='latest', azure_batch_vm_details=None, local_vars_configuration=None):  # noqa: E501
