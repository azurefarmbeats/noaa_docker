...
class JobInfo(object):
    ...
    def __init__(self, total_runs=None, time_taken_hours=None, local_vars_configuration=None):  # noqa: E501
        """JobInfo - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._total_runs = None
        self._time_taken_hours = None
    ...
    @property
    def total_runs(self):
        """Gets the total_runs of this JobInfo.  # noqa: E501

        Gets or sets total number of ADF pipeline runs.  # noqa: E501

        :return: The total_runs of this JobInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def total_runs(self, total_runs):
        """Sets the total_runs of this JobInfo.

        Gets or sets total number of ADF pipeline runs.  # noqa: E501

        :param total_runs: The total_runs of this JobInfo.  # noqa: E501
        :type: int
        """
    ...
    def time_taken_hours(self):
        """Gets the time_taken_hours of this JobInfo.  # noqa: E501

        Gets or sets total number of hours taken by job to be completed .  # noqa: E501

        :return: The time_taken_hours of this JobInfo.  # noqa: E501
        :rtype: float
        """
        return self._time_taken_hours

    @time_taken_hours.setter
    def time_taken_hours(self, time_taken_hours):
        """Sets the time_taken_hours of this JobInfo.

        Gets or sets total number of hours taken by job to be completed .  # noqa: E501

        :param time_taken_hours: The time_taken_hours of this JobInfo.  # noqa: E501
        :type: float
        """

        self._time_taken_hours = time_taken_hours
