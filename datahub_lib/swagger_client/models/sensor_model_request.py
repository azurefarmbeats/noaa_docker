...
class SensorModelRequest(object):
    ...
    def __init__(self, type=None, manufacturer=None, product_code=None, sensor_measures=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
