...
from datahub_lib.swagger_client.models.create_scene_file_response import CreateSceneFileResponse  # noqa: F401,E501


class CreateSceneFileResponseListResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[CreateSceneFileResponse]'
    }
    ...
    def __init__(self, items=None):  # noqa: E501
        """CreateSceneFileResponseListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this CreateSceneFileResponseListResponse.  # noqa: E501

        Gets or sets list of objects.  # noqa: E501

        :return: The items of this CreateSceneFileResponseListResponse.  # noqa: E501
        :rtype: list[CreateSceneFileResponse]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CreateSceneFileResponseListResponse.

        Gets or sets list of objects.  # noqa: E501

        :param items: The items of this CreateSceneFileResponseListResponse.  # noqa: E501
        :type: list[CreateSceneFileResponse]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateSceneFileResponseListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSceneFileResponseListResponse):
            return False
