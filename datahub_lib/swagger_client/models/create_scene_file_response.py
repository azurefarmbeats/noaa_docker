...
class CreateSceneFileResponse(object):
    ...
    def __init__(self, upload_sas_url=None, id=None, created_at=None, last_modified_at=None, blob_url=None, scene_id=None, type=None, content_type=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
