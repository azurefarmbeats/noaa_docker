...
class WeatherDataModelResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, weather_measures=None, name=None, description=None, properties=None):  # noqa: E501
        """WeatherDataModelResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WeatherDataModelResponse, dict):
