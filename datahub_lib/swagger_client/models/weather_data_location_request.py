...
class WeatherDataLocationRequest(object):
    ...
    def __init__(self, weather_data_model_id=None, location=None, farm_id=None, name=None, description=None, properties=None):  # noqa: E501
        """WeatherDataLocationRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WeatherDataLocationRequest, dict):
