...
class WeatherStationModelResponse(object):
    ...
    swagger_types = {
        ...
        'weather_station_measures': 'list[WeatherMeasure]',
        'name': 'str',
        'description': 'str',
    ...
    attribute_map = {
        ...
        'weather_station_measures': 'weatherStationMeasures',
        'name': 'name',
        'description': 'description',
        'properties': 'properties'
    }

    def __init__(self, id=None, created_at=None, last_modified_at=None, weather_station_measures=None, name=None, description=None, properties=None):  # noqa: E501
        """WeatherStationModelResponse - a model defined in Swagger"""  # noqa: E501

        self._id = None
        self._created_at = None
        self._last_modified_at = None
        self._weather_station_measures = None
        self._name = None
        ...
        self.weather_station_measures = weather_station_measures
        self.name = name
    ...
    @property
    def id(self):
        """Gets the id of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets unique id auto generated for the weather station type.  # noqa: E501

        :return: The id of this WeatherStationModelResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this WeatherStationModelResponse.

        Gets or sets unique id auto generated for the weather station type.  # noqa: E501

        :param id: The id of this WeatherStationModelResponse.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def created_at(self):
        """Gets the created_at of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets weather station type creation date.  # noqa: E501

        :return: The created_at of this WeatherStationModelResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this WeatherStationModelResponse.

        Gets or sets weather station type creation date.  # noqa: E501

        :param created_at: The created_at of this WeatherStationModelResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def last_modified_at(self):
        """Gets the last_modified_at of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets weather station type last updated date.  # noqa: E501

        :return: The last_modified_at of this WeatherStationModelResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_modified_at(self, last_modified_at):
        """Sets the last_modified_at of this WeatherStationModelResponse.

        Gets or sets weather station type last updated date.  # noqa: E501

        :param last_modified_at: The last_modified_at of this WeatherStationModelResponse.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def weather_station_measures(self):
        """Gets the weather_station_measures of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets list of Measurements supported by weather station.  # noqa: E501

        :return: The weather_station_measures of this WeatherStationModelResponse.  # noqa: E501
        :rtype: list[WeatherMeasure]
        """
        return self._weather_station_measures

    @weather_station_measures.setter
    def weather_station_measures(self, weather_station_measures):
        """Sets the weather_station_measures of this WeatherStationModelResponse.

        Gets or sets list of Measurements supported by weather station.  # noqa: E501

        :param weather_station_measures: The weather_station_measures of this WeatherStationModelResponse.  # noqa: E501
        :type: list[WeatherMeasure]
        """
        if weather_station_measures is None:
            raise ValueError("Invalid value for `weather_station_measures`, must not be `None`")  # noqa: E501

        self._weather_station_measures = weather_station_measures

    @property
    def name(self):
        """Gets the name of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets name to identify resource.  # noqa: E501

        :return: The name of this WeatherStationModelResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WeatherStationModelResponse.

        Gets or sets name to identify resource.  # noqa: E501

        :param name: The name of this WeatherStationModelResponse.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets textual description of resource.  # noqa: E501

        :return: The description of this WeatherStationModelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this WeatherStationModelResponse.

        Gets or sets textual description of resource.  # noqa: E501

        :param description: The description of this WeatherStationModelResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def properties(self):
        """Gets the properties of this WeatherStationModelResponse.  # noqa: E501

        Gets or sets additional properties of the resource.  # noqa: E501

        :return: The properties of this WeatherStationModelResponse.  # noqa: E501
    ...
    def properties(self, properties):
        """Sets the properties of this WeatherStationModelResponse.

        Gets or sets additional properties of the resource.  # noqa: E501

        :param properties: The properties of this WeatherStationModelResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WeatherStationModelResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WeatherStationModelResponse):
            return False
