...
class AlertRequest(object):
    ...
    @property
    def status(self):
        """Gets the status of this AlertRequest.  # noqa: E501

        Gets or sets a value indicating whether Alert is acknowledged.  # noqa: E501

        :return: The status of this AlertRequest.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AlertRequest.

        Gets or sets a value indicating whether Alert is acknowledged.  # noqa: E501

        :param status: The status of this AlertRequest.  # noqa: E501
        :type: str
        """
        if status is None:
