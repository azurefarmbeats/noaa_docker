...
class AlertResponse(object):
    ...
    def __init__(self, id=None, created_at=None, last_modified_at=None, rule_description=None, rule_severity=None, rule_id=None, rule_actions=None, device_id=None, device_msg_received=None, status=None, local_vars_configuration=None):  # noqa: E501
        """AlertResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def rule_severity(self, rule_severity):
        ...
        if self.local_vars_configuration.client_side_validation and rule_severity not in allowed_values:  # noqa: E501
            raise ValueError(
