...
class DeviceModelRequest(object):
    ...
    def __init__(self, type=None, manufacturer=None, product_code=None, ports=None, name=None, description=None, properties=None, local_vars_configuration=None):  # noqa: E501
        """DeviceModelRequest - a model defined in OpenAPI"""  # noqa: E501
